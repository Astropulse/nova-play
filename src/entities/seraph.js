...
export class Seraph {
    ...
    // ALLY MODE (the dragon fight): the resurrected Seraph fights FOR the
    // player — its entire combat AI runs unchanged, but its target list is
    // the dragon head it's dueling and its damage lands on that head.
    _bodies() {
        if (this.allyMode) {
    ...
    _startFight() {
        ...
        if (!this.allyMode) this.game.sounds.playSpecificMusic('Burning Seraph');
